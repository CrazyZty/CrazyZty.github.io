...
<table data-anchor-id="s5a0" class="table table-striped-white table-bordered">
    <tr style="text-align:center;">
        <th>名称</th> <th>字节</th> <th>说明</th>
    </tr>
    <tbody style="text-align:center;">
        <tr>
            <td>Tag</td> <td>3</td> <td>ID3V1标识符“TAG”的Ascii码</td>
        </tr>
        <tr>
            <td>Title</td> <td>30</td> <td>歌曲名</td>
        </tr>
        <tr>
            <td>Artist</td> <td>30</td> <td>歌手名</td>
        </tr>
        <tr>
            <td>Album</td> <td>30</td> <td>专辑名</td>
        </tr>
        <tr>
            <td>Year</td> <td>4</td> <td>日期信息</td>
        </tr>
        <tr>
            <td>Comment</td> <td>28</td> <td>注释信息，有时为30字节</td>
        </tr>
        <tr>
            <td>Reserved</td> <td>1</td> <td>＝0说明有音轨，下一字节就是音轨；≠0表示注释是30个字节</td>
        </tr>
        <tr>
            <td>Track</td> <td>1</td> <td>音轨（字节型数值），歌曲在专辑里的序号 </td>
        </tr>
        <tr>
            <td>Genre</td> <td>1</td> <td>歌曲风格（字节型数值）</td>
        </tr>
    </tbody>
</table>
...
<table data-anchor-id="s5a0" class="table table-striped-white table-bordered">
    ...
    <tbody style="text-align:center;">
        <tr>
            <td>Header</td> <td>3</td> <td>ID3V2.3标识符"ID3"的Ascii码，否则认为没有ID3V2.3</td>
        </tr>
        <tr>
            <td>Ver</td> <td>1</td> <td>版本号，＝03</td>
        </tr>
        <tr>
            <td>Revision</td> <td>1</td> <td>副版本号，＝00</td>
        </tr>
        <tr>
            <td>flag</td> <td>1</td> <td>标志字节，一般没意义，＝00</td>
        </tr>
        <tr>
            <td>Size</td> <td>4</td> <td>标签内容长度，高位在前，不包括标签头的10个字节</td>
        </tr>
    </tbody>
</table>
...
<table data-anchor-id="s5a0" class="table table-striped-white table-bordered">
    ...
    <tbody>
        <tr>
            <td>FrameID</td> <td>4</td> <td>帧标识符的Ascii码</td>
        </tr>
        <tr>
            <td>Size</td> <td>4</td> <td>帧内容及编码方式的合计长度，高位在前</td>
        </tr>
        <tr>
            <td>Flags</td> <td>2</td> <td>标志，只使用了6位，详见表6，一般均＝0</td>
        </tr>
        <tr>
            <td>encode</td> <td>4</td> <td>帧内容所用的编码方式。许多帧没有此项（注意，这一部分作者写错了，文档上事实并没有此属性，因为其他的文章关于标签帧的描述都没有提及此属性，故而我专门去了http://id3.org/id3v2.3.0进行考证，最后在文章3.3.ID3v2 frame overview中可以看到ID3V2标签帧并没有此内容）</td>
        </tr>
        <tr>
            <td>帧内容</td> <td></td> <td>至少 1 个字节</td>
        </tr>
    </tbody>
</table>
